type GetRequestInstanceRequest = {
  ...
  removeListener(event: `error`, listener: (err: Error) => void): GetRequestInstanceRequest
  removeListener(event: `aborted`, listener: () => void): GetRequestInstanceRequest
  removeListener(event: `data`, listener: (chunk: Buffer) => void): GetRequestInstanceRequest
  removeListener(event: `end`, listener: () => void): GetRequestInstanceRequest
  removeListener(event: `close`, listener: () => void): GetRequestInstanceRequest
}

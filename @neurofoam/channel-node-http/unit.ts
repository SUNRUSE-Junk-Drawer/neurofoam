  ...
  describe(`index`, () => {
    ...
    describe(`getBubbleUuid`, () => {
      function invalid(url: undefined | string): void {
        describe(`given ${JSON.stringify(url)}`, () =>
          it(`returns type "invalid"`, () =>
            expectAsync(
              nodeHttpChannel.getBubbleUuid({
                request: {
                  url,
                },
              })
      ...
      function maps(url: string, bubbleUuid: string): void {
        describe(`given ${JSON.stringify(url)}`, () =>
          it(`returns the extracted bubble uuid`, () =>
            expectAsync(
              nodeHttpChannel.getBubbleUuid({
                request: {
                  url,
      ...
      invalid(
        `/?anything=value&else=other&whatever=ignored#ignored-hash-fragment`
      );
      invalid(
        `/?anything=value&also-ignored&else=other&whatever=ignored#ignored-hash-fragment`
      );
      ...
      maps(
        `/teST-buBBLe-uuiD-1?anything=value&else=other`,
        `teST-buBBLe-uuiD-1`
      );
      maps(
        `/teST-buBBLe-uuiD-1?anything=value&else=other&whatever=ignored`,
        `teST-buBBLe-uuiD-1`
      );
      maps(
        `/teST-buBBLe-uuiD-1?anything=value&also-ignored&else=other&whatever=ignored`,
        `teST-buBBLe-uuiD-1`
      );
      ...
      maps(`/teST-buBBLe-uuiD-1?#ignored-hash-fragment`, `teST-buBBLe-uuiD-1`);
      maps(
        `/teST-buBBLe-uuiD-1?anything=value#ignored-hash-fragment`,
        `teST-buBBLe-uuiD-1`
      );
      maps(
        `/teST-buBBLe-uuiD-1?anything=value&else=other#ignored-hash-fragment`,
        `teST-buBBLe-uuiD-1`
      );
      maps(
        `/teST-buBBLe-uuiD-1?anything=value&else=other&whatever=ignored#ignored-hash-fragment`,
        `teST-buBBLe-uuiD-1`
      );
      maps(
        `/teST-buBBLe-uuiD-1?anything=value&also-ignored&else=other&whatever=ignored#ignored-hash-fragment`,
        `teST-buBBLe-uuiD-1`
      );
      ...
      maps(
        `/teST-buBBLe-uuiD-1/TEst-BUBBLE-UUid-2`,
        `teST-buBBLe-uuiD-1/TEst-BUBBLE-UUid-2`
      );
      maps(
        `/teST-buBBLe-uuiD-1/TEst-BUBBLE-UUid-2?`,
      ...
      maps(
        `/teST-buBBLe-uuiD-1/TEst-BUBBLE-UUid-2?anything=value`,
        `teST-buBBLe-uuiD-1/TEst-BUBBLE-UUid-2`
      );
      maps(
        `/teST-buBBLe-uuiD-1/TEst-BUBBLE-UUid-2?anything=value&else=other`,
        `teST-buBBLe-uuiD-1/TEst-BUBBLE-UUid-2`
      );
      maps(
        `/teST-buBBLe-uuiD-1/TEst-BUBBLE-UUid-2?anything=value&else=other&whatever=ignored`,
        `teST-buBBLe-uuiD-1/TEst-BUBBLE-UUid-2`
      );
      maps(
        `/teST-buBBLe-uuiD-1/TEst-BUBBLE-UUid-2?anything=value&also-ignored&else=other&whatever=ignored`,
        `teST-buBBLe-uuiD-1/TEst-BUBBLE-UUid-2`
      );
      ...
      maps(
        `/teST-buBBLe-uuiD-1/TEst-BUBBLE-UUid-2#ignored-hash-fragment`,
        `teST-buBBLe-uuiD-1/TEst-BUBBLE-UUid-2`
      );
      maps(
        `/teST-buBBLe-uuiD-1/TEst-BUBBLE-UUid-2?#ignored-hash-fragment`,
      ...
      maps(
        `/teST-buBBLe-uuiD-1/TEst-BUBBLE-UUid-2?anything=value#ignored-hash-fragment`,
        `teST-buBBLe-uuiD-1/TEst-BUBBLE-UUid-2`
      );
      maps(
        `/teST-buBBLe-uuiD-1/TEst-BUBBLE-UUid-2?anything=value&else=other#ignored-hash-fragment`,
        `teST-buBBLe-uuiD-1/TEst-BUBBLE-UUid-2`
      );
      maps(
        `/teST-buBBLe-uuiD-1/TEst-BUBBLE-UUid-2?anything=value&else=other&whatever=ignored#ignored-hash-fragment`,
        `teST-buBBLe-uuiD-1/TEst-BUBBLE-UUid-2`
      );
      maps(
        `/teST-buBBLe-uuiD-1/TEst-BUBBLE-UUid-2?anything=value&also-ignored&else=other&whatever=ignored#ignored-hash-fragment`,
        `teST-buBBLe-uuiD-1/TEst-BUBBLE-UUid-2`
      );
    ...
    describe(`getSessionUuid`, () => {
      function invalid(authorization: undefined | string): void {
        describe(`given ${JSON.stringify(authorization)}`, () =>
          it(`returns type "invalid"`, () =>
            expectAsync(
              nodeHttpChannel.getSessionUuid({
                request: {
                  headers: {
                    authorization,
                  },
      ...
      function maps(authorization: string, sessionUuid: string): void {
        describe(`given ${JSON.stringify(authorization)}`, () =>
          it(`returns the extracted session uuid`, () =>
            expectAsync(
              nodeHttpChannel.getSessionUuid({
                request: {
                  headers: {
    ...
    describe(`checkMetadata`, () => {
        ...
        describe(`given ${JSON.stringify(request)}`, () => {
          describe(`before the request footer is written`, () => {
            ...
            beforeAll(async () => {
              ...
              nodeHttpChannel.checkMetadata({ request, response }).then(
            ...
            it(`writes one request header`, () =>
              expect(writeHead).toHaveBeenCalledTimes(1));
            it(`includes status code ${statusCode}`, () =>
              expect(writeHead).toHaveBeenCalledWith(statusCode));
            it(`writes one request footer`, () =>
              expect(end).toHaveBeenCalledTimes(1));
            it(`writes the request header before the footer`, () =>
              expect(writeHead).toHaveBeenCalledBefore(end));
          ...
          describe(`after the request footer is written`, () => {
            ...
            it(`does not write any further request headers`, () =>
              expect(writeHead).toHaveBeenCalledTimes(1));
            it(`does not write any further request footers`, () =>
              expect(end).toHaveBeenCalledTimes(1));
            it(`resolves the promise to false`, () =>
              expectAsync(promise).toBeResolvedTo(false));
          });
        });
      }
      ...
      describe(`when the request is valid`, () => {
        ...
        it(`does not write a request header`, () =>
          expect(writeHead).not.toHaveBeenCalled());
        it(`does not write a request footer`, () =>
          expect(end).not.toHaveBeenCalled());
        it(`resolves the promise to true`, () =>
          expectAsync(promise).toBeResolvedTo(true));
      });
    ...
    describe(`getRequestLength`, () => {
      function none(contentLength: undefined | string): void {
        describe(`given ${JSON.stringify(contentLength)}`, () =>
          it(`returns a type of "none"`, () =>
            expectAsync(
              nodeHttpChannel.getRequestLength({
                request: {
                  headers: {
      ...
      function maps(contentLength: string, length: number): void {
        describe(`given ${JSON.stringify(contentLength)}`, () =>
          it(`returns the extracted content length`, () =>
            expectAsync(
              nodeHttpChannel.getRequestLength({
                request: {
                  headers: {
      ...
      describe(`given no content-length header`, () =>
        it(`returns type "none"`, () =>
          expectAsync(
            nodeHttpChannel.getRequestLength({
              request: {
    ...
    describe(`getRequest`, () => {
      function doesNotComplete(
        ...
        describe(description, () => {
          ...
          beforeAll(async () => {
            ...
            act({
              error(err: Error): void {
                addListener.calls
                  .allArgs()
                  .filter((call) => call[0] === `error`)[0][1](err);
              },
              aborted(): void {
                addListener.calls
                  .allArgs()
                  .filter((call) => call[0] === `aborted`)[0][1]();
              },
              data(chunk: Buffer): void {
                addListener.calls
                  .allArgs()
                  .filter((call) => call[0] === `data`)[0][1](chunk);
              },
              end(): void {
                addListener.calls
                  .allArgs()
                  .filter((call) => call[0] === `end`)[0][1]();
              },
            });
          ...
          it(`registers one error handler`, () =>
            expect(addListener).toHaveBeenCalledWith(
              `error`,
              jasmine.any(Function)
            ));
          it(`registers one aborted handler`, () =>
            expect(addListener).toHaveBeenCalledWith(
              `aborted`,
              jasmine.any(Function)
            ));
          it(`registers one data handler`, () =>
            expect(addListener).toHaveBeenCalledWith(
              `data`,
              jasmine.any(Function)
            ));
          it(`registers one end handler`, () =>
            expect(addListener).toHaveBeenCalledWith(
              `end`,
              jasmine.any(Function)
            ));
          it(`does not register any further handlers`, () =>
            expect(addListener).toHaveBeenCalledTimes(4));
          it(`does not deregister any handlers`, () => () =>
            expect(removeListener).not.toHaveBeenCalled());
          it(`does not resolve or reject the returned promise`, () =>
            expect(resolvedOrRejected).toBeFalsy());
        });
      }
      ...
      function completes(
        ...
        describe(description, () => {
          ...
          it(`does not register any further handlers`, () =>
            expect(addListener).toHaveBeenCalledTimes(4));
          it(`deregisters the error handler`, () =>
            expect(removeListener).toHaveBeenCalledWith(
              `error`,
              addListener.calls
                .allArgs()
                .filter((call) => call[0] === `error`)[0][1]
            ));
          it(`deregisters the aborted handler`, () =>
            expect(removeListener).toHaveBeenCalledWith(
              `aborted`,
              addListener.calls
                .allArgs()
          ...
          it(`deregisters the data handler`, () =>
            expect(removeListener).toHaveBeenCalledWith(
              `data`,
              addListener.calls
                .allArgs()
                .filter((call) => call[0] === `data`)[0][1]
            ));
          it(`deregisters the end handler`, () =>
            expect(removeListener).toHaveBeenCalledWith(
              `end`,
              addListener.calls
                .allArgs()
          ...
          it(`does not deregister any further handlers`, () =>
            expect(removeListener).toHaveBeenCalledTimes(4));
          it(`resolves the promise`, () =>
            expectAsync(promise).toBeResolvedTo(result));
        });
      }
      ...
      describe(`when some of the data is received`, () => {
        ...
        describe(`then some more of the data is received`, () => {
          ...
          completes(
            `then too much data is received`,
            (callbacks) => {
              callbacks.data(Buffer.from([0x54, 0x65, 0x73]));
              callbacks.data(Buffer.from([0x74, 0x20]));
        ...
        completes(
          ...
          (callbacks) => {
            callbacks.data(
              Buffer.from([0x54, 0x65, 0x73, 0x74, 0x20, 0x53, 0x74])
            );
      ...
      describe(`when all of the data is received`, () => {
        doesNotComplete(`then nothing happens`, (callbacks) => {
          callbacks.data(
            Buffer.from([0x54, 0x65, 0x73, 0x74, 0x20, 0x53, 0x74, 0x72])
          );
        });
      ...
      completes(
        `when decoding fails in a one part message`,
        (callbacks) => {
          callbacks.data(
            Buffer.from([0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x20, 0xe3, 0x81])
          );
          callbacks.end();
        },
        {
      ...
      completes(
        `when decoding fails in a two part message`,
        (callbacks) => {
      ...
      completes(
        `when decoding fails in a three part message`,
        (callbacks) => {
      ...
      completes(
        `when decoding only succeeds by waiting until the entire string is available`,
        (callbacks) => {
    ...
    describe(`respondWithError`, () => {
        ...
        describe(`given error ${JSON.stringify(error)}`, () => {
          describe(`when the callback is not executed`, () => {
            ...
            beforeAll(() => {
              ...
              nodeHttpChannel.respondWithError({ response }, error).then(
                () => (resolvedOrRejected = true),
                () => (resolvedOrRejected = true)
              );
            });

            it(`writes one response header`, () =>
              expect(writeHead).toHaveBeenCalledTimes(1));
            it(`includes HTTP status code in the response header`, () =>
              expect(writeHead).toHaveBeenCalledWith(statusCode));
            it(`writes one response footer`, () =>
              expect(end).toHaveBeenCalledTimes(1));
            it(`writes the response header before the response footer`, () =>
              expect(writeHead).toHaveBeenCalledBefore(end));
            it(`includes the response body in the footer`, () =>
              expect(end).toHaveBeenCalledWith(jasmine.anything()));
            it(`does not reject or resolve the returned promise`, () =>
              expect(resolvedOrRejected).toBeFalse());
          });
          ...
          describe(`when the callback is executed`, () => {
            ...
            it(`does not write another response header`, () =>
              expect(writeHead).toHaveBeenCalledTimes(1));
            it(`does not write another response footer`, () =>
              expect(end).toHaveBeenCalledTimes(1));
      ...
      function ignores(error: neurofoamTypes.ErrorResponse): void {
        describe(`given error ${JSON.stringify(error)}`, () => {
          ...
          it(`does not write a response header`, () =>
            expect(writeHead).not.toHaveBeenCalled());
          it(`does not write a response footer`, () =>
            expect(end).not.toHaveBeenCalled());
          it(`resolves the returned promise`, () =>
            expectAsync(promise).toBeResolved());
        });
      ...
      describe(`when no session uuid is given`, () => {
        describe(`when the callback is not executed`, () => {
          ...
          beforeAll(async () => {
            ...
            nodeHttpChannel.respond({ response }, null, `Test Response`).then(
              () => (resolvedOrRejected = true),
              () => (resolvedOrRejected = true)
            );
        ...
        describe(`when the callback is executed`, () => {
          ...
          beforeAll(async () => {
            ...
            promise = nodeHttpChannel.respond(
              { response },
              null,
              `Test Response`
            );
      ...
      describe(`when a session uuid is given`, () => {
        describe(`when the callback is not executed`, () => {
          ...
          beforeAll(async () => {
            ...
            nodeHttpChannel
              .respond({ response }, `Test Session Uuid`, `Test Response`)
              .then(
                () => (resolvedOrRejected = true),
                () => (resolvedOrRejected = true)
              );
          ...
          it(`writes one response header`, () =>
            expect(writeHead).toHaveBeenCalledTimes(1));
          it(`includes HTTP status code in the response header`, () =>
            expect(writeHead).toHaveBeenCalledWith(200, jasmine.anything()));
          it(`includes an Authorization HTTP header in the response header`, () =>
            expect(writeHead).toHaveBeenCalledWith(
              jasmine.anything(),
              jasmine.objectContaining({
                Authorization: `BEARER Test Session Uuid`,
              })
            ));
          it(`writes one response footer`, () =>
            expect(end).toHaveBeenCalledTimes(1));
